...
export const songCatalog: SongMeta[] = [
  {
    ...
    activities: ["Can and can't", "Will for support", "Word choice"],
  ...
  },
  {
    ...
    activities: ["Past simple", "Two-letter words", "Sentence order"],
  ...
  },
  {
    ...
    activities: ["Two-letter words", "Past simple", "Sentence order"],
  ...
  },
  {
    ...
    activities: ["Pronouns", "Past participles", "Sentence order"],
  ...
  },
  {
    ...
    activities: ["Simple present", "Simple past", "Word recognition"],
  ...
  },
  {
    ...
    activities: ["Phrasal verbs", "Adjectives and adverbs", "Sentence order"],
  ...
  },
  {
    ...
    activities: ["Nature vocabulary", "Where vs. we're", "Missing words"],
