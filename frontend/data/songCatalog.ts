...
export const songCatalog: SongMeta[] = [
  ...
  },
  {
    ...
    level: "Elementary",
    duration: "40 min",
    topic: "Love, marriage, and family approval",
    genre: "Reggae",
    description: "Practice prepositions and informal expressions through a story about love, marriage, and family approval.",
    activities: ["Prepositions", "Inline word order", "Emoji gaps"],
    coverImage: "/images/songs/rude/cover.jpg",
    coverClass: "song-art--rude",
  },
  {
    slug: "stupid-song",
    title: "stupid song",
    ...
    level: "Pre-intermediate",
    duration: "50 min",
    topic: "Love, obsession, and emotional intensity",
    genre: "Pop",
    description: "Practice present perfect and other verb forms while exploring the intense and sometimes confusing feelings of falling in love.",
  ...
  {
    slug: "self-dysmorphia",
    title: "Self Dysmorphia",
    artist: "Mckenna Grace",
    level: "Intermediate+",
    duration: "45 min",
    topic: "Body image, confidence, and social media",
    genre: "Pop",
    description: "Explore superlatives and language about appearance while discussing body image, comparison, and social-media pressure.",
    activities: ["Superlatives", "Incomplete words", "Word presence"],
    coverImage: "/images/songs/self-dysmorphia/cover.jpg",
    coverClass: "song-art--self-dysmorphia",
  },
  {
    slug: "young-and-dumb",
    title: "Young & Dumb",
    artist: "Avril Lavigne feat. Simple Plan",
    level: "Pre-intermediate",
    duration: "45 min",
    topic: "Youth, nostalgia, and growing older",
    genre: "Pop punk",
    description: "Practice past forms and informal -ing pronunciation through a nostalgic pop-punk song about youth and growing older.",
